    ...
    <div className="bg-warning bg-opacity-10 d-flex flex-column min-vh-100">
      ...
      <div className="position-relative">
        ...
        <div className="position-absolute top-50 start-50 translate-middle text-center text-white">
          ...
          <button className="btn btn-dark text-white fw-bold px-4">Explorer le Menu</button>
        </div>
      </div>
      ...
      <div className="container-fluid py-5">
        ...
        <section className="mb-5 text-center">
          <h1 className="h3 fw-bold text-dark mb-3">À Propos de Nous</h1>
        ...
        <section className="row align-items-center mb-5">
          <div className="col-md-6 mb-4 mb-md-0">
            <h2 className="h4 fw-bold text-dark mb-3">Découvrez notre Culture</h2>
            <p className="text-muted mb-3">
            ...
            <button className="btn btn-dark text-white fw-bold">En Savoir Plus</button>
          </div>
        ...
        <section className="mb-5">
          <h2 className="h4 fw-bold text-dark mb-4 text-center">Nos Spécialités</h2>
          <div className="row g-4">
            <div className="col-md-4">
              <div className="bg-warning bg-opacity-25 p-3 rounded shadow-sm h-100">
                ...
                />
                <p className="fw-bold text-dark">Momos Traditionnels</p>
            ...
            <div className="col-md-4">
              <div className="bg-warning bg-opacity-25 p-3 rounded shadow-sm h-100">
                <img 
                  ...
                  style={{ height: '12rem', objectFit: 'cover', width: '100%' }}
                />
                <p className="fw-bold text-dark">Thali Népalais</p>
            ...
            <div className="col-md-4">
              <div className="bg-warning bg-opacity-25 p-3 rounded shadow-sm h-100">
                ...
                <p className="fw-bold text-dark">Nos Spécialités</p>
                <p className="text-muted">Découvrez notre menu complet</p>
              </div>
            </div>
          </div>
          <div className="text-center mt-4">
            <button className="btn btn-dark text-white fw-bold px-4">Voir le Menu</button>
          </div>
        </section>

        {/* Reservation */}
        <section className="bg-warning bg-opacity-25 p-4 rounded shadow-sm mb-5">
          <h2 className="h4 fw-bold text-dark text-center mb-4">Réservez une table</h2>
          <form onSubmit={handleReservation}>
            <div className="row g-3">
              ...
              <div className="col-12 text-center mt-3">
                <button type="submit" className="btn btn-dark text-white fw-bold px-5">
                  Réserver
                </button>
              </div>
            </div>
