  ...
  const platsBiryani = [
    {
      ...
      description: "Plat traditionnelle Indien préparé avec du riz basmati parfumé, différentes épices, des raisins sec, des noix de cajou, dans une sauce curry avec légumes.",
      price: 14.90,
      image: '/images/dal-bhat.jpg',
    },
    {
      id: 'b2',
      name: 'Biryani Poulet',
      description: "Plat traditionnelle Indien préparé avec du riz basmati parfumé, différentes épices, des raisins sec, des noix de cajou, dans une sauce curry avec poulet.",
      price: 15.50,
      image: '/images/momo.jpg',
    },
    {
      id: 'b3',
      name: 'Biryani Agneau ',
      description: "Plat traditionnelle Indien préparé avec du riz basmati parfumé, différentes épices, des raisins sec, des noix de cajou, dans une sauce curry avec agneau.",
      price: 17.50,
      image: '/images/dal-bhat.jpg',
    },
    {
      ...
      description: "Plat traditionnelle Indien préparé avec du riz basmati parfumé, différentes épices, des raisins sec, des noix de cajou, dans une sauce curry avec crevettes.",
      price: 17.90,
      image: '/images/dal-bhat.jpg',
    },
    {
      id: 'b5',
      name: 'Biryani Maison',
      description: "Plat traditionnelle Indien préparé avec du riz basmati parfumé, différentes épices, des raisins sec, des noix de cajou, dans une sauce curry avec agneau, poulet et crevettes.",
      price: 19.00,
      image: '/images/dal-bhat.jpg',
    }
